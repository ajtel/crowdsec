...
# Paso 1: Agregar repo manualmente (forzando el de CentOS 7)
...
echo "✅ CrowdSec instalado y sincronización lista entre nodos."
echo "📌 Asegúrate de tener claves SSH distribuidas entre nodos para que funcione el SCP sin contraseña."
